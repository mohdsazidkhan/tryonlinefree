...
const Disclaimer = () => {
  return (
    <>
      <Helmet>
        <title>Tryonlinefree - Privacy Policy</title>
        <meta
          name="description"
      ...
      <NavBar />
      <div className="container mx-auto mb-10 py-5 disclaimer">
        <h1>Disclaimer</h1>
        ...
        <ul>
          <li>
            ...
            this Disclaimer) refers to Tryonlinefree.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to Tryonlinefree, accessible from{' '}
            <a
              href="https://www.tryonlinefree.com/"
              rel="noreferrer"
              target="_blank"
            >
              https://www.tryonlinefree.com/
            </a>
          </li>
        </ul>
        <h1>Disclaimer</h1>
        ...
        <ul>
          <li>
            <p>By email: tryonlinefree@gmail.com</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{' '}
              <a
                href="https://www.tryonlinefree.com/contact"
                rel="noreferrer"
                target="_blank"
              >
                https://www.tryonlinefree.com/contact
              </a>
            </p>
          </li>
        </ul>
